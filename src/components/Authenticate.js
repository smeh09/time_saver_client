      ...
      <div id='authentication-modal-inner'>
        <div id='authentication-heading-links'>
          <div className='authentication-link-container'>
            <Link className='authentication-link' id={type === 'sign_in' ? 'selected' : ''} to='/authenticate?type=sign_in'>Sign in</Link>
          </div>
          <div className='authentication-link-container'>
            <Link className='authentication-link' id={type === 'sign_up' ? 'selected' : ''} to='/authenticate?type=sign_up'>Sign up</Link>
          </div>
        </div>
            ...
            ? 
              <>
                ...
                <div id='authenticate-submit-button-container'>
                  <button type='submit' id='authenticate-submit-button'>Sign In! </button>
                </div>
              </>
            : 
              <>
                ...
                <div id='authenticate-submit-button-container'>
                  <button type='submit' id='authenticate-submit-button'>Sign Up! </button>
                </div>
              </> 
          }
          </form>
